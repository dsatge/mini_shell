...
/*   Updated: 2025/04/17 17:55:29 by enschnei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// COMMANDS
int					ft_builtin(t_env_head *env_head, char **envp,
						t_minish *minish);
...
int					ft_exit(t_env_head *env_head, char **envp,
						t_minish *minish);
...
int					exec_one_cmd(t_minish *minish, t_o_cmd *o_cmd,
						t_env_head *env_head);
int					exec_multiple_cmds(t_o_cmd **o_cmd, t_minish *minish,
						t_env_head *env_head);
// EXEC_ONLY_CMD
...
void				last_exe(t_list *cmds, t_minish *minish, t_o_cmd *o_cmd,
						t_env_head *env_head);
int					no_cmd_exe(t_list *cmds, t_minish *minish,
						t_env_head *env_head);
...
// EXEC_INCHILD
int					ft_redir_manager(t_list *cmds, t_pipe *pipex,
